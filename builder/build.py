...
from brbpkg.generator import Info, xbuild, wbuild, build


parser = argparse.ArgumentParser(
    prog="bibata_rainbow_builder",
    description="'Bibata Rainbow' cursor build python script.",
)
...
comments = {
    "Bibata-Rainbow-Modern": "Rounded-edge Bibata cursors with Rainbow colors",
    "Bibata-Rainbow-Original": "Sharp-edge Bibata cursors with Rainbow colors",
}
